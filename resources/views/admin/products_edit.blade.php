...
@section('title', 'Изменение продукта: '.$product['product_name'])
@section('content')
    <div class="row">
        <div class="col-lg-6">
            <form role="form" method="POST" action="{{ url('/admin/products/save') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="product_active" name="product_active">
                        <option {{ $product['product_active'] == 1 ? 'selected':''}} value="1">Да</option>
                        <option {{ $product['product_active'] == 0 ? 'selected':''}} value="0">Нет</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="product-preview">
                        <img class="mx-auto" id="product-image"
                             src="{{ url('/images/'.$product['product_image']) }}" alt="">
                    </div>
                </div>
